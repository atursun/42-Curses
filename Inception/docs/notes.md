...
2. ISO Dosyası:
bir disk işletim sisteminin dijital kopyasıdır. İçerisinde işletim sisteminin dosyaları, kurulum verileri, sistem dosyaları ve genellikle önyükleme için gerekli dosyalar bulunur. Bu, bir CD, DVD (Veri Depolama) veya USB'ye yazılarak fiziksel bir disk gibi kullanılabilir.
