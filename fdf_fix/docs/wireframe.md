...
| Yöntem | Yapı Taşı | Görünüm | En İyi Örnek |
| :--- | :--- | :--- | :--- |
| **Wireframe** | Çizgiler | İskelet/Tel | **FDF Projesi** |
| **Point Cloud** | Noktalar | Toz Bulutu | 3D Tarayıcılar |
| **Polygon Mesh** | Yüzeyler (Üçgen) | Kabuk/Deri | Video Oyunları |
| **Voxel** | Küpler | Blok Blok | Minecraft |